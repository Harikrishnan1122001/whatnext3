    ...
    <section className="enquiry" id="enquire" ref={revealRef}>
      <div className="container enquiry__inner">
        <div className="enquiry__copy reveal">
          ...
          <h2>Talk to a Mentor. Find the Right Course for Your Career.</h2>
          <p>
            Not sure which course matches your goals? Share your interests and
            we'll help you choose the right learning path based on your
            background, career aspirations, and current skill level. Our team
            will guide you through course details, upcoming batches, fees, and
            enrollment.
          </p>
